...
if($senha_log == $senha && $nivel == 0){
	...
	if($registro == true){
		...
		echo "<p style='text-align: center; color: #333; padding: 5px;'>Membro deletado com sucesso!<br>";
		echo "<a href='form_excluir_pessoas.php' style='color: #59f'>Voltar para o formulário</a>";
		echo "</p>";
