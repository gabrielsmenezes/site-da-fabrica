                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('projeto.update', $projeto->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                value="{{$projeto->descricao}}" rows="5" required autocomplete="descricao">{{$projeto->descricao}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ $projeto->finalizado }}" rows="5" required autocomplete="finalizado">
                                            <option value=1 @if ($projeto->finalizado == 1) selected="selected"@endif>Sim</option> 
                                            <option value=0 @if ($projeto->finalizado == 0) selected="selected"@endif>Não</option> 
                                    </select>
                                    @error('descricao')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
