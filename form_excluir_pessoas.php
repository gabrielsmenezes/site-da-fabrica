...
<html>
	...
	<body>
		<div id="box_form">
			<h1 class="tituloPostPessoa" style="margin-left: 10%">Formulário: exclusão de pessoas</h1>
			<form action="excluir_pessoas.php" method="POST" enctype="multipart/form-data">
