...
<html>
	...
	<body>
		<div id="box_form">
			<h1 class="tituloPostPessoa" style="margin-left: 10%">Formulário: exclusão de projetos</h1>
			<form action="excluir_projetos.php" method="POST" enctype="multipart/form-data">
