<div id="conteudo_editais">
	...
	while($line = mysqli_fetch_array($sel_parcial)){
		$caminho_arquivo = $line['caminho_arquivo'];
		$nome = $line['nome'];
	...
	<div class="posts_editais">
		...
		<p><a href="postagens_editais/<?php echo "post".$id_post."/".$caminho_arquivo;?>" class="link_edital" target="_blank"><?php echo $nome;?></a></p>
	</div>
