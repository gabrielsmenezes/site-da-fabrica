...
<html>
	...
	<body>
		<div id="box_form">
			<h1 class="tituloPostPessoa" style="margin-left: 10%">Formulário: exclusão de editais</h1>
			<form action="excluir_editais.php" method="POST" enctype="multipart/form-data">
				<input type="text" name="nome" class="campos_cad" placeholder="Digite o nome do edital">
				<div id="botoes">
