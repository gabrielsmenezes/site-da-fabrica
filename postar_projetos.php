...
if($senha_log == $senha && $nivel == 0){
	...
	if($registro == true && $teste == true){
		...
		mysqli_query($link, "INSERT INTO tb_postagensprojetos(nome_imagem, tamanho_imagem, tipo_imagem, imagem, nome, descricao, categoria, id_user) 
			VALUES('$foto', '$tamanho_foto', '$tipo', '$conteudo', '$nome', '$descricao', '$categoria','$id_user')");

		echo "<p style='text-align: center; color: #333; padding: 5px;'>Projeto cadastrado com sucesso!<br>";
		echo "<a href='form_postagem_projetos.php' style='color: #59f'>Voltar para o formulário</a>";
		echo "</p>";

	}else{
		echo "Não foi possível cadastrar esse conteúdo<br>";
		echo "<a href= form_postagem_projetos.php>Voltar ao formulário</a>";
	}
