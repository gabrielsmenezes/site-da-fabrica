...
<div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Listar Posts</h1>
   
            <?php
                foreach((array)$args as $p){
                    echo '<div style="border:1px solid black; width: 100%;">'.$p->getConteudo().'</div>';
                    if(isset($_SESSION['user'])){
                        echo "<form action='/?pagina=post-remove&id=".$p->getId()."' method='post'>
